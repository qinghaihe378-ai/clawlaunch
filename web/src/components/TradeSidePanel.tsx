...
export default function TradeSidePanel({ token, onClose, isOpen }: SidePanelProps) {
  ...
  return (
    <>
      ...
      {/* 侧边面板 */}
      <aside 
        className="fixed right-0 top-0 z-50 h-full w-full max-w-[448px] bg-[rgb(17,19,26)] shadow-2xl transform transition-transform duration-300 ease-out overflow-y-auto"
        style={{
